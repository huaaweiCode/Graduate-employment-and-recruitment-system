...
<@override name="title">修改招聘信息页</@override>
<@override name="content">
			...
			<table class="ui celled striped  table">
				...
				<tr>
					...
					<td class="four wide  center aligned">
						<div class="field">
							<input type="text" name="position" value="${recruit.position}">
						</div>
					</td>
				...
				<tr>
					...
					<td class="four wide center aligned">
						<div class="field">
							<input type="text" name="number" value="${recruit.number}">
						</div>
					</td>
					...
					<td class="four wide center aligned">
						<div class="field">
							<select class="ui dropdown" name="address">
								<option value="${recruit.address}">工作地</option>
				...
				<tr>
					...
					<td class="four wide  center aligned">
						<div class="field ">
							<select class="ui dropdown  " name="degree">
								<option value="${recruit.degree}">选择学历</option>
					...
					<td class="four wide  center aligned">
						<div class="field">
							<input type="text" name="major" value="${recruit.major}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="field">
							<input name="recruitid" value="${recruit.recruitid}" type="hidden">
						</div>
					</td>
				</tr>
				</tbody>
	...
	<script>
        ...
        $('.ui.form').form({
            ...
            method: 'POST',
            url: '${base}/company/edit_save',
            serializeForm: true,
            success: function (res) {
                if (res.success) {
                    alert(res.message);
                    window.location.href = '${base}/company/ManageRecruit'
                } else {
