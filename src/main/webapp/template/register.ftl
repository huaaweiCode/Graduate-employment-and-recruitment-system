...
<div class="ui large  menu center aligned grey inverted ">
    ...
    <div class="right menu">
        <div class="item">
            <#--			<a class="ui primary button labeled icon" href="#"><i class="user icon"></i> 登陆</a>-->
        </div>
        <div class="item">
            <a class="ui primary button  labeled icon" href="#"><i class="registered icon"></i>注册</a>
        </div>
    </div>
</div>
</div>
    ...
    <tr>
        ...
        <td class="seven wide">
            ...
            <table class="ui red table">
                ...
                <tr>
                    <td>
                            <a class="ui massive fluid button primary"  href="${base}/registerStu" >
                                <i class="user icon"></i>
                                学生注册
                            </a>
                    </td>
                ...
                <tr>
                    <td>
                        <a class="ui massive fluid button primary" href="${base}/registerCompany">
                            <i class="user icon" ></i>
                            企业注册
                        </a>
                    </td>
