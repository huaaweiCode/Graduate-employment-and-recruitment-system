...
<@override name="title">修改${student.name!''}毕业去向</@override>
<@override name="content">
				...
				<tr>
					...
					<td class="four wide  center aligned">
						<div class="field disabled">
							<input type="text" name="id" value="${whereabouts.id!''}" hidden>
						</div>
						<div class="field ">
	...
	<script>
        ...
        $('.ui.form').form({
            ...
            method: 'POST',
            url: '${base}/admin/DoModifyWhereabouts',
            serializeForm: true,
            success: function (res) {
                if (res.success) {
                    alert(res.message);
                    window.location.href = '${base}/admin/findDetailOneWhereabouts/${whereabouts.id!''}'
                } else {
